    ...
    >
      ...
      <div className="flex gap-4 justify-end justify-self-end items-center">
        <div className="hidden md:flex">
          <TransitionCTA href={CTA.primary.href} variant={isEditorialCase ? 'ghost' : 'ghostLight'} className="px-4 py-2 text-xs">
            {CTA.primary.label}
          </TransitionCTA>
        </div>
      ...
      >
        <div className="flex flex-col gap-8 px-6 pt-8 pb-10">
          ...
          <TransitionCTA href={CTA.primary.href} variant="primary" onClick={closeMobile} className="justify-center px-4 py-3 w-full text-xs">
            {CTA.primary.label}
          </TransitionCTA>
        </div>
      </div>
