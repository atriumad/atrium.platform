...
export function Marquee({
  ...
  const repeatedItems = Array.from({ length: repeat }, (_, index) => `marquee-repeat-${index}`)
  ...
  return (
    <>
      ...
      <div
        {...props}
        className={cn(
          'flex overflow-hidden p-2 group gap-(--gap) [--duration:40s] [--gap:1rem]',
          {
            'flex-row': !vertical,
            'flex-col': vertical,
