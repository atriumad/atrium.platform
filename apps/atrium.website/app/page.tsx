...
const bentoItems: BentoItem[] = [
  ...
  { size: 'small', title: <>Reviews caught <em>before they go public</em></>, body: 'The happy guest goes to Google. The unhappy one comes to you first. We catch the problems early and push the rating up over time.', cover: 'Survey flow diagram' },
  ...
  { size: 'small', title: <>Traffic that <em>turns into tables</em></>, body: 'We send people from Instagram and Google straight to your reservation and your online order, not just to your profile.', cover: 'Instagram profile linking through to a reservation confirmation' },
]
