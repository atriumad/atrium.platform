...
export function Logo({
  ...
  if (variant === 'mark') {
    return (
      <span className={cn('inline-flex text-charcoal', className)} role="img" aria-label="Atrium">
  ...
  return (
    <span className={cn('inline-flex items-center gap-[0.5em] text-charcoal', className)} role="img" aria-label="Atrium">
